...
export default function GitHubCalender1() {
  ...
  return (
    <Box id="gitHub_page"  p="2rem 0rem" h={["auto","auto","150vh"]}  >
    ...
    >
        ...
        <Image mt="5%" borderRadius={"xl"} alt="${SHARUN266} Activity Graph" src="https://activity-graph.herokuapp.com/graph?username=SHARUN266&bg_color=0D1117&color=5BCDEC&line=8FFC21&point=FFFFFF&hide_border=false"></Image>
        </Box>
